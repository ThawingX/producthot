...
function App() {
    ...
    <div key={channel.id} className={`liquid-glass p-6 rounded-3xl bg-gradient-to-br ${channel.bgGradient} shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2`}>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          <div className="p-3 rounded-2xl floating-glass backdrop-blur-sm" style={{ backgroundColor: `${channel.color}15`, color: channel.color, boxShadow: `0 4px 16px ${channel.color}20` }}>
            {channel.icon}
          </div>
          <div>
            <h3 className="text-lg font-bold text-gray-800 tracking-tight">{channel.name}</h3>
            <p className="text-sm text-gray-600 font-medium">更新于 {channel.updateTime}</p>
          </div>
        </div>
  ...
  const renderClueAnalysisPage = () => (
    <div className="max-w-4xl mx-auto space-y-8">
      {/* Hero Section */}
      <div className="glass-card p-8 rounded-2xl backdrop-blur-md bg-gradient-to-r from-purple-500/20 to-indigo-500/20 border border-white/30 shadow-lg text-center">
        <div className="mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="glass-card p-6 rounded-2xl backdrop-blur-md bg-white/40 border border-white/30 shadow-lg">
          <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
      ...
      <div className="glass-card p-6 rounded-2xl backdrop-blur-md bg-white/40 border border-white/30 shadow-lg">
        ...
        <div className="relative h-64 bg-gradient-to-br from-[#4792E6]/5 to-purple-500/5 rounded-lg border border-[#4792E6]/20 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-lg font-medium text-gray-800 mb-2">AI驱动的智能分析引擎</p>
          ...
          <div className="absolute top-12 right-8 w-3 h-3 bg-green-500 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
          ...
          <div className="absolute top-1/2 left-8 w-3 h-3 bg-red-500 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
          <div className="absolute top-1/3 right-12 w-3 h-3 bg-yellow-500 rounded-full animate-pulse" style={{animationDelay: '2.5s'}}></div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 header-glass shadow-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            {/* Logo */}
            <div className="flex items-center">
              <div className="floating-glass p-3 rounded-2xl bg-gradient-to-r from-blue-500/15 to-indigo-500/15">
            ...
            <div className="hidden md:flex items-center">
              ...
              <button className="ml-4 p-3 rounded-2xl floating-glass hover:bg-white/20 transition-all duration-300 hover:scale-110">
            ...
            <button
              ...
              className="md:hidden p-3 rounded-2xl floating-glass hover:bg-white/20 transition-all duration-300"
            >
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden header-glass border-t border-white/10">
