  ...
  return (
    <div className="overflow-hidden pt-20 min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50">
      <div className="px-6 py-12 mx-auto max-w-6xl">
        ...
        {/* 功能特性 - 增强真实性、专业性和高效性 */}
        <div className={`grid grid-cols-1 gap-8 mb-16 md:grid-cols-2 lg:grid-cols-3 transition-all duration-500 ${activeTab === 'features' ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-full absolute'}`}>
        ...
        {/* 使用场景 */}
        <div className={`mb-16 transition-all duration-500 ${activeTab === 'scenarios' ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-full absolute'}`}>
